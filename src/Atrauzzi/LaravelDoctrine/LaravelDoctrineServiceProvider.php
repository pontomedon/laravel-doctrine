...
class LaravelDoctrineServiceProvider extends ServiceProvider {
	...
	public function register() {
		...
		App::singleton('doctrine', function ($app) {
			...
			// for a production system you'll want to use a real caching system like APC,
			// get rid of EchoSqlLogger, and turn off autoGenerateProxyClasses.
			// For more details, consult the Doctrine 2 Configuration documentation.
			// http://docs.doctrine-project.org/projects/doctrine-orm/en/latest/#configuration-options
